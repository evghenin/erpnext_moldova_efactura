...
app_include_css = ["/assets/erpnext_moldova_efactura/css/purchase_factura.css"]
app_include_js = [
...
doctype_js = {
    ...
    "Purchase Factura": "public/js/purchase_factura_import_v3.js",
}
doctype_list_js = {
...
extend_bootinfo = "erpnext_moldova_efactura.boot.extend_bootinfo"
